...
public class PlayerControllerTest {
    ...
    public void postItemTransaction_ValidCampaign_ValidPlayer_ValidContentType() throws Exception {
        when(itemTransactionRepository.save(any(ItemTransaction.class))).thenReturn(FIRST_PLAYER);
    ...
    private class ItemTransactionRepository {
        Player save(ItemTransaction transaction) {
            return null;
        }
    }

    private static class ItemTransaction {
        public ItemTransaction setPlayer(Player firstPlayer) {
            return this;
        }
        ...
        public ItemTransaction setQuantity(int i) {
            return this;
        }
    }
}
